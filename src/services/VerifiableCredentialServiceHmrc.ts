...
export class VerifiableCredentialServiceHmrc {
	...
	private static instance: VerifiableCredentialServiceHmrc;
	...
	static getInstance(kmsJwtAdapter: KmsJwtAdapter, issuer: string, logger: Logger, dnsSuffix: string): VerifiableCredentialServiceHmrc {
		if (!VerifiableCredentialServiceHmrc.instance) {
			VerifiableCredentialServiceHmrc.instance = new VerifiableCredentialServiceHmrc(kmsJwtAdapter, issuer, logger, dnsSuffix);
		}
		return VerifiableCredentialServiceHmrc.instance;
	}
