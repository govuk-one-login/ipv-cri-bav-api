...
export class PartialNameProcessor {
  private static instance: PartialNameProcessor;
  ...
  static getInstance(logger: Logger, metrics: Metrics): PartialNameProcessor {
  	if (!PartialNameProcessor.instance) {
  		PartialNameProcessor.instance = new PartialNameProcessor(logger, metrics);
  	}
  	return PartialNameProcessor.instance;
  }
