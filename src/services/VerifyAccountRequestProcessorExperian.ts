...
export class VerifyAccountRequestProcessorExperian {
  private static instance: VerifyAccountRequestProcessorExperian;
  ...
  private readonly experianToken: string;
	...
	static getInstance(logger: Logger, metrics: Metrics, EXPERIAN_TOKEN: string): VerifyAccountRequestProcessorExperian {
  	if (!VerifyAccountRequestProcessorExperian.instance) {
  		VerifyAccountRequestProcessorExperian.instance = new VerifyAccountRequestProcessorExperian(logger, metrics, EXPERIAN_TOKEN);
  	}
  	return VerifyAccountRequestProcessorExperian.instance;
	}
