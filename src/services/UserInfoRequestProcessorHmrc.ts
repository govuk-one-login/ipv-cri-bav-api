...
import { VerifiableCredentialServiceHmrc } from "./VerifiableCredentialServiceHmrc";

export class UserInfoRequestProcessorHmrc {
  private static instance: UserInfoRequestProcessorHmrc;
  ...
  private readonly kmsDecryptor: KmsJwtAdapter;
	...
	private readonly verifiableCredentialService: VerifiableCredentialServiceHmrc;
	...
	constructor(logger: Logger, metrics: Metrics) {
  	...
  	this.kmsDecryptor = new KmsJwtAdapter(signinKeyIds);
		this.verifiableCredentialService = VerifiableCredentialServiceHmrc.getInstance(this.kmsDecryptor, this.issuer, this.logger, this.dnsSuffix);
	}

	static getInstance(logger: Logger, metrics: Metrics): UserInfoRequestProcessorHmrc {
  	if (!UserInfoRequestProcessorHmrc.instance) {
  		UserInfoRequestProcessorHmrc.instance = new UserInfoRequestProcessorHmrc(logger, metrics);
  	}
  	return UserInfoRequestProcessorHmrc.instance;
	}
