...
process.env.CLIENT_CONFIG = '[{"jwksEndpoint":"https://api.identity.account.gov.uk/.well-known/jwks.json","clientId":"ipv-core-stub","redirectUri":"http://localhost:8085/callback","experianVerifyEndpoint":"https://localhost/verify","experianTokenEndpoint":"https://localhost/token"}]'
